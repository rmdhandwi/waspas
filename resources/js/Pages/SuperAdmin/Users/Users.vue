                ...
                >
                    ...
                    >
                        ...
                        <div class="flex items-center gap-4 my-4">
                            <label for="username" class="font-semibold w-40"
                                >Username</label
                            >
                            <InputText
                        ...
                        <div class="flex items-center gap-4 my-4">
                            <label for="nama" class="font-semibold w-40"
                                >Nama</label
                            >
                            <InputText
                        ...
                        <div class="flex items-center gap-4 my-4">
                            <label for="email" class="font-semibold w-40"
                                >Email</label
                            >
                            <InputText
                        ...
                        <div class="flex items-center gap-4 my-4">
                            <label for="tglLahir" class="font-semibold w-40"
                                >Tanggal Lahir</label
                            >
                            <DatePicker
                                v-model="userForm.tgl_lahir"
                                class="flex-auto"
                                id="tglLahir"
                                showIcon
                                fluid
                        ...
                        <div class="flex items-center gap-4 my-4">
                            <label for="jkel" class="font-semibold w-40"
                                >Jenis Kelamin</label
                            >
                            <Select
                                id="jkel"
                                v-model="userForm.jkel"
                                :options="jkel"
                                optionValue="jenis"
                                optionLabel="jenis"
                        ...
                        <div class="flex items-center gap-4 my-4">
                            <label for="password" class="font-semibold w-40"
                                >Password</label
                            >
                            <Password
                        ...
                        <div class="flex items-center gap-4 my-4">
                            <label for="no_telp" class="font-semibold w-40"
                                >No Telp</label
                            >
                            <InputText
                        ...
                        <div class="flex items-center gap-4 my-4">
                            <label for="alamat" class="font-semibold w-40"
                                >Alamat</label
                            >
                            <InputText
                                v-model="userForm.alamat"
                                id="alamat"
                                class="flex-auto"
                                autocomplete="off"
