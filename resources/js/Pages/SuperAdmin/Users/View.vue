        ...
        <template #pageContent>
            ...
            <div class="flex flex-col gap-[1rem]">
                ...
                <form
                    ...
                    class="flex flex-col gap-[2rem] p-4"
                    autocomplete="off"
                >
                    <div class="flex flex-wrap items-center gap-[2rem]">
                        ...
                        <div class="flex flex-col gap-2">
                            <label for="tglLahir" class="font-medium"
                                >Tanggal Lahir</label
                            >
                            <DatePicker
                                ...
                                id="tglLahir"
                                autocomplete="off"
                                :modelValue="userForm.tgl_lahir"
                                class="w-[20rem]"
                            />
                        </div>
                        <div class="flex flex-col gap-2">
                            <label for="jkel" class="font-medium"
                                >Jenis Kelamin</label
                            >
                            <Select
                                id="jkel"
                        ...
                        <div class="flex flex-col gap-2">
                            <label for="no_telp" class="font-medium"
                                >No Telp</label
                            >
                            <InputText
                        ...
                        <div class="flex flex-col gap-2">
                            <label for="alamat" class="font-medium"
                                >Alamat</label
                            >
                            <InputText
